...
--> statement-breakpoint
INSERT INTO `__new_user_master`("id", "name", "birthday", "last_login_date", "dark_mode", "delete_flg", "created_at", "updated_at") SELECT "id", "name", "birthday", "last_login_date", "dark_mode", "delete_flg", "created_at", "updated_at" FROM `user_master`;--> statement-breakpoint
